...
<a href="#speciality" className='flex items-center gap-2 bg-white  px-3 py-3 rounded-lg text-gray-600 text-sm m-auto md:m-0 hover:scale-105 transition-all duration-300'>
